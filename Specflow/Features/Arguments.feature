...
Background: Pre-Condition
	# Given Steps
	Given User is at Home Page with url "http://127.0.0.1:5001/"
...
Scenario: Login scenario of BugZilla
	...
	When I provide the "danpocchini@bugzilla.com", "dani123" and click on Login button
...
Scenario: Create Bug scenario of Bugzilla_1
	...
	| A        | File a Bug | Log in to Bugzilla | danpocchini@bugzilla.com | dani123 | Enter Bug | Enter Bug: Testng | critical | Macintosh | Other    | Summary - 1 | Desc - 1 |
	| B        | File a Bug | Log in to Bugzilla | danpocchini@bugzilla.com | dani123 | Enter Bug | Enter Bug: Testng | major    | Other     | Linux    | Summary - 2 | Desc - 2 |
